...
- dont try to max or min just ask your self how can I find such answer, by trying all the pssiooblity of answer using BS
- Know if you can do BS in the all answer possiblity if the answers set are monotonic means [1,1,1,1,0,0,0,0]
## Sliding Window
### Sup Sup Topic Name
