...
* Write the solution in the [Solutions library](https://github.com/basmaashouur/Competitive-Programming/blob/master/Solutions-library), or if it's a contest make a folder contains all the problems of that contest. 
