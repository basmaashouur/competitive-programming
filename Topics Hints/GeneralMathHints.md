* Do we need to calculate the exact number to get our answer or we just wanna compare, if just compare we may use log rules with the very big exponent number.
